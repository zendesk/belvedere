...
class MediaSource {
     ...
     *      the system.
     */
    Pair<MediaIntent, BelvedereResult> getCameraIntent(int requestCode){
     ...
     *      the system.
     */
    private Pair<MediaIntent, BelvedereResult> pickImageFromCameraInternal(Context context, int requestCode){
